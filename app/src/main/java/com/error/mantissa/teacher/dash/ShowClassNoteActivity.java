...
public class ShowClassNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_show_class_note);

        EbookrecyclerView=findViewById(R.id.classnoteRecycleView);

        list = new ArrayList<>();
        dept=findViewById(R.id.pdf11);

        Ses = findViewById(R.id.pdf22);
        Sem = findViewById(R.id.pdf33);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    EbookrecyclerView.setLayoutManager(new LinearLayoutManager(ShowClassNoteActivity.this));
                    adapter=new ShowPdfAdapter(ShowClassNoteActivity.this,list,"ClassNote");
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(ShowClassNoteActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
