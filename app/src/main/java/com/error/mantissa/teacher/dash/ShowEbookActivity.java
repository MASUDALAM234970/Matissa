...
public class ShowEbookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EbookrecyclerView=findViewById(R.id.Showpdf);

       list = new ArrayList<>();
        dept=findViewById(R.id.pdf1);

        Ses = findViewById(R.id.pdf2);
        Sem = findViewById(R.id.pdf3);
...
// Apply the adapter to the spinner
    ...
    private void csDepartment() {
        reference = reference.child("Ebook");
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    EbookrecyclerView.setLayoutManager(new LinearLayoutManager(ShowEbookActivity.this));
                    adapter=new ShowPdfAdapter(ShowEbookActivity.this,list,"Ebook");
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(ShowEbookActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
