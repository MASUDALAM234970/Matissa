...
import com.error.mantissa.databinding.ActivityEbookBinding;
...
/*
        ...
        binding.Session1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                AlertDialog accountsDialog = new AlertDialog.Builder(EbookActivity.this).create();
                ...
                SectionAdapter adapter=new SectionAdapter(EbookActivity.this, sectionModels, new SectionAdapter.SectionClickListener() {
                    @Override
                ...
                dialogBinding.recyclerView.setLayoutManager(new LinearLayoutManager(EbookActivity.this));
                dialogBinding.recyclerView.addItemDecoration(new DividerItemDecoration(EbookActivity.this,DividerItemDecoration.VERTICAL));
        ...
        binding.account1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                AccountsAdapter adapter= new AccountsAdapter(EbookActivity.this, accounts, new AccountsAdapter.AccountsClickListener() {
                    @Override
    ...
    private void UploadData() {
        ...
        reference123.child(dept).child(ses).child(sem).child("Ebook").child(unique_key).setValue(data).addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
