...
import com.error.mantissa.adapter.UserAdapter;
...
public class StudentNoticeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deleteRecyclerView.setLayoutManager(new LinearLayoutManager(StudentNoticeActivity.this));
    ...
    private void getNotice() {
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter= new UserAdapter(StudentNoticeActivity.this,list);
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                ...
                Toast.makeText(StudentNoticeActivity.this,"SomethingError"+error.getMessage(),Toast.LENGTH_SHORT).show();
            }
        });
