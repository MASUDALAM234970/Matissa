...
import com.error.mantissa.adapter.VideoShiowAdapter;
...
public class StudentShowVedioLectureMainActivity extends AppCompatActivity {
    ...
    private ArrayList<Notepdf> csList;
    private VideoShiowAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_show_vedio_lecture_main);



        // Initialize views
        //  departmentSpinner = findViewById(R.id.departmentSpinner1);
        recyclerView = findViewById(R.id.stVedioLecture);
...
*/
        dept = findViewById(R.id.show1111);
        Ses = findViewById(R.id.show2222);
        Sem = findViewById(R.id.show3333);
...
// Apply the adapter to the spinner
    ...
    private void csDepartment() {
        reference = reference.child("VideoLecture");
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    recyclerView.setLayoutManager(new LinearLayoutManager(StudentShowVedioLectureMainActivity.this));
                    adapter = new VideoShiowAdapter(StudentShowVedioLectureMainActivity.this,csList, "VideoLecture");
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(StudentShowVedioLectureMainActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
