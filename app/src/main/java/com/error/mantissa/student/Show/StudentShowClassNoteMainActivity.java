...
public class StudentShowClassNoteMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_show_class_note_main);


        EbookrecyclerView=findViewById(R.id.stClassNote);

        list = new ArrayList<>();
        dept=findViewById(R.id.show11);

        Ses = findViewById(R.id.show22);
        Sem = findViewById(R.id.show33);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (!dataSnapshot.exists()) {
                    ...
                    EbookrecyclerView.setLayoutManager(new LinearLayoutManager(StudentShowClassNoteMainActivity.this));
                    adapter=new ShowPdfAdapter(StudentShowClassNoteMainActivity.this,list,"ClassNote");
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                ...
                Toast.makeText(StudentShowClassNoteMainActivity.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
